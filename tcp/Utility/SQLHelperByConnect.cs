...
namespace tcp
{
    ...
    /// SqlServer数据访问接口实现
    /// </summary> 
    public class SQLHelperByConnect
    {
      //  private string connect = "Data Source=.;Initial Catalog=SRWare;User ID=sa;Password=123456";
        /// <summary>
        /// 执行命令,并返回影响函数
        /// </summary>
        ...
        public static int ExecuteNonQuery(string strConnect, string strSQL, object param)
        {
            return DbHelper.ExecuteNonQuery(strConnect, strSQL, param);
        }
        
        public static DataTable ExecuteQuery(string strConnect, string strSQL, object param)
        {
            return DbHelper.ExecuteQuery(strConnect, strSQL, param);
        }
